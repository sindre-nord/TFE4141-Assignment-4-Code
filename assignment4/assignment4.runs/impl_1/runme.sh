...
HD_PWD='X:/Assignment4/assignment4/assignment4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log latch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source latch.tcl -notrace
